...
func getFriendListHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(user.GetFriendRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(user.UserService).GetFriendList(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetFriendListArgs:
		success, err := handler.(user.UserService).GetFriendList(ctx, s.Req)
		if err != nil {
			return err
		}
...
var GetFriendListArgs_Req_DEFAULT *user.GetFriendRequest

func (p *GetFriendListArgs) GetReq() *user.GetFriendRequest {
	if !p.IsSetReq() {
...
type GetFriendListResult struct {
	Success *user.GetFriendResponse
}

var GetFriendListResult_Success_DEFAULT *user.GetFriendResponse

func (p *GetFriendListResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.GetFriendResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *GetFriendListResult) Unmarshal(in []byte) error {
	msg := new(user.GetFriendResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetFriendListResult) GetSuccess() *user.GetFriendResponse {
	if !p.IsSetSuccess() {
...
func (p *GetFriendListResult) SetSuccess(x interface{}) {
	p.Success = x.(*user.GetFriendResponse)
}
...
var GetUsersResult_Success_DEFAULT *user.UserListResponse
...
func (p *GetUsersResult) GetSuccess() *user.UserListResponse {
	if !p.IsSetSuccess() {
...
func actionCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(user.ActionCommentRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(user.UserService).ActionComment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *ActionCommentArgs:
		success, err := handler.(user.UserService).ActionComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *ActionCommentArgs) Unmarshal(in []byte) error {
	msg := new(user.ActionCommentRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var ActionCommentArgs_Req_DEFAULT *user.ActionCommentRequest

func (p *ActionCommentArgs) GetReq() *user.ActionCommentRequest {
	if !p.IsSetReq() {
...
type ActionCommentResult struct {
	Success *user.ActionCommentResponse
}

var ActionCommentResult_Success_DEFAULT *user.ActionCommentResponse

func (p *ActionCommentResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.ActionCommentResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *ActionCommentResult) Unmarshal(in []byte) error {
	msg := new(user.ActionCommentResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *ActionCommentResult) GetSuccess() *user.ActionCommentResponse {
	if !p.IsSetSuccess() {
...
func (p *ActionCommentResult) SetSuccess(x interface{}) {
	p.Success = x.(*user.ActionCommentResponse)
}
...
func getCommentHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	case *streaming.Args:
		st := s.Stream
		req := new(user.GetCommentRequest)
		if err := st.RecvMsg(req); err != nil {
			return err
		}
		resp, err := handler.(user.UserService).GetComment(ctx, req)
		if err != nil {
			return err
		}
		if err := st.SendMsg(resp); err != nil {
	...
	case *GetCommentArgs:
		success, err := handler.(user.UserService).GetComment(ctx, s.Req)
		if err != nil {
			return err
		}
...
func (p *GetCommentArgs) Unmarshal(in []byte) error {
	msg := new(user.GetCommentRequest)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Req = msg
...
var GetCommentArgs_Req_DEFAULT *user.GetCommentRequest

func (p *GetCommentArgs) GetReq() *user.GetCommentRequest {
	if !p.IsSetReq() {
...
type GetCommentResult struct {
	Success *user.GetCommentResponse
}

var GetCommentResult_Success_DEFAULT *user.GetCommentResponse

func (p *GetCommentResult) FastRead(buf []byte, _type int8, number int32) (n int, err error) {
	if !p.IsSetSuccess() {
		p.Success = new(user.GetCommentResponse)
	}
	return p.Success.FastRead(buf, _type, number)
}
...
func (p *GetCommentResult) Unmarshal(in []byte) error {
	msg := new(user.GetCommentResponse)
	if err := proto.Unmarshal(in, msg); err != nil {
		return err
	}
	p.Success = msg
...
func (p *GetCommentResult) GetSuccess() *user.GetCommentResponse {
	if !p.IsSetSuccess() {
...
func (p *GetCommentResult) SetSuccess(x interface{}) {
	p.Success = x.(*user.GetCommentResponse)
}
...
func (p *kClient) GetFriendList(ctx context.Context, Req *user.GetFriendRequest) (r *user.GetFriendResponse, err error) {
...
func (p *kClient) GetUsers(ctx context.Context, Req *user.GetUserSRequest) (r *user.UserListResponse, err error) {
...
func (p *kClient) ActionComment(ctx context.Context, Req *user.ActionCommentRequest) (r *user.ActionCommentResponse, err error) {
...
func (p *kClient) GetComment(ctx context.Context, Req *user.GetCommentRequest) (r *user.GetCommentResponse, err error) {
